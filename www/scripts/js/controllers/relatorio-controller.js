  ...
  .controller(
    ...
    function ($scope, pass, alertAction, relatorioAction, formatValor) {
      ...
      const RenderizarGrafico = (getDados) => {
        var size = 0.0;
        const fixSize = 3.6;
        const porcentagem = relatorioAction.CalculaPorcentagem(
          getDados.entradaValorTotal,
        ...
        relatorioAction
          ...
          .then((res) => {
            ...
            $scope.relatorio = {
              ...
              investimentos: res.listaInvestimentos,
              graphicInvestimento: [res.graphicInvestimento],
              totalInvestimentos: res.resultValorTotal.investimetosValorTotal,
              entrada: {
                porcentagem: porcentagem,
              },
              classColorSaldoGeral: res.resultValorTotal.classColorSaldoGeral,
            };
