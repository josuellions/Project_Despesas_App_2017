  ...
  .controller(
    ...
    function (
      ...
      const ExibirListaView = (dados) => {
        ...
        $scope.despesaValorTotal = formatValor.ptBr(somaDespesa);
      ...
      const CopyMesAnterior = (dataInicio, response) => {
        ...
        alertAction
          .question(
            `Adicionar despesas com base no mês anterior,\n "${dtMesAnteriorFormat}"?`,
            action.copyDespesa,
      ...
      $scope.submitDelete = (despesa) => {
        alertAction
          .question(
            `Deseja excluir despesa? "${despesa.nome}"?`,
