...
console.log('aqui')
	...
	//	$('#dtReference').append('teste','teste') // defineMes());
	...
	// Controle de Versão
	$("#contVer").text("Versão beta 0.0.9-AngularJS - 20/07/2018");

	//Nome Desenvolvedor
	$("#nomeDeveloper").text("&copy 2017 - Josuel A. Lopes");

	//Nome Empresa Desenvolvedora
	$("#nomeEmpresa").text("&reg Seven Solutions Tecnologic");
